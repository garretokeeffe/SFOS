  ...
  template: `
    <div *ngIf="capacities.length" class="padding-horizontal padding-bottom margin-bottom">
      <div *ngIf="capacities[0].fleetSubSegment !== FleetSubSegment['NONE']"
           class="wizard-label margin-top color-primary"
           [class.margin-bottom]="!pointsEnabled || displayMode === 'GRID'">
        {{ (capacities[0]).displayFleetSubSegment() }}
        <span *ngIf="offRegisterProposed" class="error">&nbsp;*** PROPOSED ***</span>
        <span *ngIf="showSubSegmentTotal" class="color-primary-soft margin-left"
              style="text-transform: none">{{ CapacityManager.getTotalCapacity(capacities) }}</span>
      </div>
      ...
      <table *ngIf="displayMode === 'TABLE'" mat-table [dataSource]="capacities">
        ...
        <ng-container matColumnDef="vesselName">
          ...
          <td mat-cell *matCellDef="let capacity" [class.alignCols]="alignColumns"
              [class.pointsEnabled]="pointsEnabled">
        ...
        <ng-container matColumnDef="vesselCapacity">
          <th mat-header-cell *matHeaderCellDef class="color-primary"><span *ngIf="offRegisterProposed">Target </span>Vessel
            Capacity
          </th>
        ...
        <ng-container matColumnDef="offRegisterDate">
          ...
          <td mat-cell *matCellDef="let capacity" class="centered-content">01/01/2019</td>
          <!-- {{ capacity.offRegisterDate || '-'}} -->
        </ng-container>
        <ng-container matColumnDef="capacityExpiryDate">
          ...
          <td mat-cell *matCellDef="let capacity" class="centered-content">31/12/2020</td>
          <!-- {{ capacity.offRegisterExpiryDate || '-'}} -->
        </ng-container>
        ...
        <tr mat-header-row *matHeaderRowDef="fleetSubSegmentColumns"
            [class.hidden]="!pointsEnabled &&!showVesselCapacity && (!offRegister && !offRegisterProposed)"></tr>
        <tr mat-row *matRowDef="let row; columns: fleetSubSegmentColumns;"></tr>
      </table>

      <div *ngIf="displayMode === 'GRID'">
        <div fxLayout="(isHandset$ | async) ? 'row' : 'column'" fxLayoutAlign="start stretch" fxLayoutGap="16px"
             class="mat-card-group">
            ...
            <mat-card #card class="margin-bottom" [@fadeInOut]="'fadeIn'">
              <mat-card-header>
                <mat-card-title>
                  ...
                  <div *ngIf="offRegisterProposed" fxFill fxLayout="row" fxLayoutAlign="start center"
                       fxLayoutGap="16px">
                    <mat-icon>directions_boat</mat-icon>
              ...
              <mat-card-content>
                <div fxFill fxLayout="row" fxLayoutAlign="center start" fxLayoutGap="16px" class="margin-top-double">
                  ...
                  <div *ngIf="showVesselCapacity">
                    <div class="text-small card-data-header"><span *ngIf="offRegisterProposed">Target&nbsp;</span>Vessel&nbsp;Capacity
                    </div>
                  ...
                  <div *ngIf="pointsEnabled && !(isHandset$ | async)" class="left">
                    ...
                    <div *ngIf="!capacity.penaltyPoints || !capacity.penaltyPoints.length"
                         class="card-data centered-content">0
                    </div>
                    <div *ngFor="let penaltyPoints of capacity.penaltyPoints"
                         class="card-data centered-content">{{ penaltyPoints.numberOfPoints }}</div>
                    <div *ngIf="capacity.penaltyPoints && capacity.penaltyPoints.length > 1"
                         class="card-data centered-content border-top">
                  ...
                  <div *ngIf="pointsEnabled && !(isHandset$ | async)" class="left">
                    ...
                    <div *ngIf="!capacity.penaltyPoints || !capacity.penaltyPoints.length"
                         class="card-data centered-content">-
                    </div>
                    <div *ngFor="let penaltyPoints of capacity.penaltyPoints"
                         class="card-data centered-content">{{ penaltyPoints.expiryDate || '-' }}</div>
                  </div>
                </div>
                <div *ngIf="pointsEnabled && (isHandset$ | async)" fxFill fxLayout="row" fxLayoutAlign="center start"
                     fxLayoutGap="16px" class="margin-top">
                  <div class="left">
                    <div class="text-small card-data-header">Points</div>
                    <div *ngIf="!capacity.penaltyPoints || !capacity.penaltyPoints.length"
                         class="card-data centered-content">0
                ...
                <div *ngIf="offRegister || offRegisterProposed" fxFill fxLayout="row" fxLayoutAlign="center start"
                     fxLayoutGap="16px" class="margin-top">
                  <div fxFlexAlign="start">
                    <div class="text-small card-data-header">Off Register Since</div>
                    <div class="card-data centered-content">01/01/2019</div>
                    <!-- {{ capacity.offRegisterDate || '-' }} -->
                  </div>
                  <div class="left">
                    <div class="text-small card-data-header">Capacity Expires</div>
                    <div class="card-data centered-content">31/12/2020</div>
                    <!-- {{ capacity.offRegisterExpiryDate || '-' }} -->
                  </div>
                </div>
                <div *ngIf="capacity.trackRecord && capacity.trackRecord.type && displayTrackRecord" fxFill
                     fxLayout="column" fxLayoutAlign="center start" class="margin-top">

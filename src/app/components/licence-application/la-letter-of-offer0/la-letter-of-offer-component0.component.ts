...
@Component({
  selector: 'app-la-letter-of-offer0',
  templateUrl: './la-letter-of-offer-component0.component.html',
  styleUrls: ['./la-letter-of-offer-component0.component.css'],
  animations: animations,
})
export class LaLetterOfOfferComponent0 implements OnInit, OnChanges {

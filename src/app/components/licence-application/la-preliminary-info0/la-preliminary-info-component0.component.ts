...
@Component({
  selector: 'app-la-preliminary-info0',
  templateUrl: './la-preliminary-info-component0.component.html',
  styleUrls: ['./la-preliminary-info-component0.component.css'],
  animations: animations
})
export class LaPreliminaryInfoComponent0 implements OnInit, AfterViewChecked {
